...
exports.formatAPDU = function(value) {
    if (value == null) 
        return log.error('Conversion error DPT237: cannot write null value');
    ...
    return log.error('Conversion error DPT237: Must supply an value {address:[0,63] or [0,15], address type:{0,1}, ...}');
}

exports.fromBuffer = function(buf) {
    if (buf.length !== 2)
    return log.error('Conversion error DPT237: Buffer should be 2 byte long');
