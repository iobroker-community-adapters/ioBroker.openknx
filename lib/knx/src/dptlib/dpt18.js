...
exports.formatAPDU = function (value) {
    if (value == null) log.warn("DPT18: cannot write null value");
        ...
        if (typeof value == 'object' &&
            ...
            return log.error("Conversion error DPT18: Must supply a value object of {save_recall, scenenumber}");
        }
        return apdu_data;
    }
}
...
exports.fromBuffer = function (buf) {
    ...
    if (buf.length != 1) {
        return log.error("Conversion error DP18: Buffer should be 1 byte long");
    } else {
