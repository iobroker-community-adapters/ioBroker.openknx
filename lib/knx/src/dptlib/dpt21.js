...
exports.formatAPDU = function(value) {
    if (value == null) 
        return log.error('Conversion error DPT21: cannot write null value');
    ...
    return log.error('Conversion error DPT21: Must supply a value which is an object');    
}

exports.fromBuffer = function(buf) {
    if (buf.length != 1) 
        return log.error('Conversion error DPT21: Buffer should be 1 byte long');
