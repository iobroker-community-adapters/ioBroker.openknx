...
exports.subtypes = {
  '014': { //ID
    use: 'G', //Use
    name: 'DPT_Beaufort_Wind_Force_Scale',  //Name
...
exports.subtypes = {
  '122': { //ID
    use: 'HVAC', //Use
    name: 'DPT_StartSynchronization',  //Name
    desc: 'AlarmClass_HVAC', //Encoding field1
    range: [0, 2], //Range
...
exports.subtypes = {
  '1001': { //ID
    use: 'System', //Use
    name: 'DPT_AddInfoTypes',  //Name
    desc: 'AddInfoType', //Encoding field1
    range: [0, 7], //Range
    enc: {
      0: 'reserved',
      0: 'PL medium Domain Address',
      2: 'RF Control Octet and Serial Number or DoA',
      3: 'Busmonitor Error Flags',
      4: 'Relative timestamp',
      5: 'Time delay',
