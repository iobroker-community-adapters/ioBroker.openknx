...
/**
 * Translates text to the target language. Automatically takes the right translation API.
 *
...
/*
 * iobroker does not support all characters, substitute by _
 */
...
function isTriggerDPT(dpt) {
    ...
    return (
        ...
        dpt === "DPT26" ||
        dpt.startsWith("DPT26.") ||
        dpt === "DPT238" ||
        dpt.startsWith("DPT238.") ||
        dpt === "DPT3" || //dimming
        dpt.startsWith("DPT3.")
    );
}
...
/* check if it is a Device Address is in a.b.c format */
