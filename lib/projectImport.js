...
module.exports = {
    ...
    parseInput: function (adapter, xml, callback) {
        ...
        if (xml) {
            ...
            adapter.log.info("Parse xml succsessful");
            fileObjectList["ga.xml"] = doc;
        }
    ...
    generateIoBObjects: function (adapter, fileObjectList, callback) {
        ...
        function processFile(adapter, err, objectList) {
            ...
            _.each(groupAddresses, function (groupAddress) {
                ...
                adapter.log.debug("process groupAddress: " + gaName);
                let autoread = true;
                ...
                adapter.log.debug("fullPath " + fullPath);
                let range = [,];
                let role = "state";
                let type;
