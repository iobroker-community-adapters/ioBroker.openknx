    ...
    generateIoBObjects: function (adapter, fileObjectList, callback) {
        ...
        function processFile(adapter, err, objectList) {
            ...
            _.each(groupAddresses, function (groupAddress) {
                ...
                dpt = tools.convertDPTtype(groupAddress.getAttribute("DatapointType") || groupAddress.getAttribute("DPTs")); //DPT or DPTs
                if (dpt == "") {
                    const text = `Ignoring ${fullPath} because no DPT is assigned to ${groupAddress.getAttribute("Address")}.`;
...
>>>>>>> a97d6f3158a61451c5312fd3c3bd82a841eb1ac4
